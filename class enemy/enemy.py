...
class Player2(pygame.sprite.Sprite):
    def __init__(self, x, y, player, speed):
        super().__init__()
        # Load ghost image
        original_image = pygame.image.load("ENEMY/halloween_13474950.png").convert_alpha()
        # Adjust the size of the image
        scaled_width = 35  # Adjust this value as needed for the desired width
        scaled_height = 35  # Adjust this value as needed for the desired height
